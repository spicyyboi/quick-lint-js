...
#define QLJS_X_ERROR_TYPES                                                     \
  QLJS_ERROR_TYPE(                                                             \
      ...
      .error(QLJS_TRANSLATE("variable assigned before its declaration"), assignment)         \
          .note(QLJS_TRANSLATE("variable declared here"), declaration))                      \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
      error_assignment_to_const_global_variable, { identifier assignment; },   \
      .error(QLJS_TRANSLATE("assignment to const global variable"), assignment))             \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
  ...
  QLJS_ERROR_TYPE(                                                             \
      ...
      .error(QLJS_TRANSLATE("assignment to const variable before its declaration"),          \
             assignment)                                                       \
          .note(QLJS_TRANSLATE("const variable declared here"), declaration))                \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
  ...
  QLJS_ERROR_TYPE(                                                             \
      ...
      .error(QLJS_TRANSLATE("let statement cannot declare variables named 'let'"), name))    \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
      error_cannot_export_let, { source_code_span export_name; },              \
      .error(QLJS_TRANSLATE("cannot export variable named 'let'"), export_name))             \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
  ...
  QLJS_ERROR_TYPE(                                                             \
      ...
      .error(QLJS_TRANSLATE("escaped character is not allowed in identifiers"),              \
             escape_sequence))                                                 \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
  ...
  QLJS_ERROR_TYPE(                                                             \
      ...
      { source_code_span escape_sequence; },                                   \
      .error(QLJS_TRANSLATE("expected hexadecimal digits in Unicode escape sequence"),       \
             escape_sequence))                                                 \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
  ...
  QLJS_ERROR_TYPE(                                                             \
      ...
      { source_code_span escape_sequence; },                                   \
      .error(QLJS_TRANSLATE("keywords cannot contain escape sequences"), escape_sequence))   \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
  ...
  QLJS_ERROR_TYPE(                                                             \
      ...
      { source_code_span where; },                                             \
      .error(QLJS_TRANSLATE("missing comma between object literal entries"), where))         \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
  ...
  QLJS_ERROR_TYPE(                                                             \
      ...
      .error(QLJS_TRANSLATE("number literal contains consecutive underscores"),              \
             underscores))                                                     \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
      error_redeclaration_of_global_variable, { identifier redeclaration; },   \
      .error(QLJS_TRANSLATE("redeclaration of global variable"), redeclaration))             \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
      ...
      .error(QLJS_TRANSLATE("redeclaration of variable: {0}"), redeclaration)                \
          .note(QLJS_TRANSLATE("variable already declared here"), original_declaration))     \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
  ...
  QLJS_ERROR_TYPE(                                                             \
      ...
      { source_code_span escape_sequence; },                                   \
      .error(QLJS_TRANSLATE("unclosed identifier escape sequence"), escape_sequence))        \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
  ...
  QLJS_ERROR_TYPE(                                                             \
      ...
      .error(QLJS_TRANSLATE("unexpected characters in number literal"), characters))         \
                                                                               \
  QLJS_ERROR_TYPE(                                                             \
